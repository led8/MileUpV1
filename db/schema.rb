...
ActiveRecord::Schema.define(version: 2019_09_27_050606) do
  ...
  create_table "cities", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_cities_on_email", unique: true
    t.index ["reset_password_token"], name: "index_cities_on_reset_password_token", unique: true
  end
  ...
  create_table "info_equipments", force: :cascade do |t|
    ...
    t.index ["city"], name: "index_info_equipments_on_city"
    t.index ["rating"], name: "index_info_equipments_on_rating"
